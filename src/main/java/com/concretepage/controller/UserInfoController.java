...
public class UserInfoController {
	...
	public ModelAndView app_insert(Model model,@RequestParam(value="id",required=false,defaultValue="") String id,
			...
			@RequestParam(value="conttent",required=false,defaultValue="")String conttent) throws Exception {
	    ModelAndView mav = new ModelAndView();
	    java.sql.Connection conn=ConnectionUtils.getMyConnection();
	    PreparedStatement pr;
    ...
    public static Credential authorize() throws Exception {
        // Load client secrets.
        InputStream in =
            UserInfoController.class.getResourceAsStream("/client_secret.json");
